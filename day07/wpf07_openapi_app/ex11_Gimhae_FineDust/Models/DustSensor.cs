...
namespace ex11_Gimhae_FineDust.Models
{
    public class DustSensor
    {
        ...
        public static string INSERT_QUERY = @"INSERT INTO [dbo].[Dustsensor]
                                                           ([Dev_id]
                                                           ,[Name]
                                                           ,[Loc]
                                                           ,[Coordx]
        ...
        public static string SELETE_QUERY = @"SELECT [Id]
                                                      ,[Dev_id]
                                                      ,[Name]
                                                      ,[Loc]
                                                      ,[Coordx]
        ...
        public static string GETDATE_QUERY = @"SELECT CONVERT(CHAR(10), Timestamp, 23) AS Save_Date
                                          FROM [dbo].[DustSensor]
